...
//        pers2.setId(22L);
        ...
        pers2.setVersion(1);
        AdresseBasic adresse = new AdresseBasic("rue du boeuf",null,"Niort","79000");
    ...
    public void testReadPersonnes_int_int() {
        ...
        int maxResults = 2;
        int expResult = 2;
        Collection<PersonneBasic> result = personneDao.readPersonnes(startIndex, maxResults);
        assertEquals(expResult, result.size());
        for (PersonneBasic personne : result) {
            logger.debug("Personne :" + personne);
        }
